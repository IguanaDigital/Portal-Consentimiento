...
@Component({
    ...
    templateUrl: './../users/list-users/list-users.component.html',
...
export class UserRxjsComponent implements OnInit {
    ...
    config: any;
    editUser: UntypedFormGroup | null = null;
    ...
    constructor(private userService: UserRxjsServiceService, private fb: UntypedFormBuilder, private modalService: NgbModal, private datePipe: DatePipe) {
